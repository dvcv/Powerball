...
For a list of all winning tickets please contact owner at 760-574-4503 or use the attched code below.
...
barplot(x,las=2,names.arg=c("5W 1R","5W","4W 1R","4W","3W 1R","3W","2W 1R","1W 1R","  1R","Total"),col=rainbow(10),main=paste(n,"Lottery Tickets"),ylab="Winning Tickets")
...
barplot(x,las=2,names.arg=c("5W 1R","5W","4W 1R","4W","3W 1R","3W","2W 1R","1W 1R","1R","Total"),col=rainbow(10),main=paste(n,"Lottery Tickets"),ylab="Money Won")


```
```{r, echo=FALSE}
barplot(c(2*n,winnings,abs(2*n-winnings)),col=c(44:46),names.arg=c("Spent on Tickets","Won","Difference"),ylab="Money")
```
